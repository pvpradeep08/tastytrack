        ...
        <ul class="nav-links">
          ...
          <li>
            ...
            <a href="../cart?restaurantId=<%= session.getAttribute("currentRestaurantId") != null ? session.getAttribute("currentRestaurantId") : 0 %>&action=<%= sampleAction %>">
              <ion-icon name="cart"></ion-icon><span class="nav-text">Cart</span>
            </a>
          </li>
          <li>
            <a href="../orders"><ion-icon name="paper-plane"></ion-icon><span class="nav-text">Orders</span></a>
          </li>
          <li>
            <a href="../dashboard">
              <ion-icon name="person-circle"></ion-icon><span class="nav-text">
    ...
    <div class="cart-container">
      ...
      <% if (cart != null && !cart.getCart().isEmpty()) { %>
        <div class="cart-summary">
          ...
          <a class="checkout-btn" href="../pages/checkout.jsp">Proceed to Checkout</a>
        </div>
      <% } %>
    </div>
